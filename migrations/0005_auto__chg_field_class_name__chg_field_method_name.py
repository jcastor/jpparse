...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Class.name'
        db.alter_column('jpparse_class', 'name', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'Method.name'
        db.alter_column('jpparse_method', 'name', self.gf('django.db.models.fields.CharField')(max_length=400))
